...
unclog_levels_t unclog_levels[] = {
    {1400, "Fatal", 'F'},  {1200, "Critical", 'C'}, {1000, "Error", 'E'},
    {800, "Warning", 'W'}, {600, "Info", 'I'},      {400, "Debug", 'D'},
    {200, "Trace", 'T'},   {-1, NULL, '\0'},
};
...
static void unclog_defaults_handler(void* target, const char* name,
                                    const char* value) {
